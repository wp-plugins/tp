...
function tp_override_options($options) {
	if (defined('TWITTER_CONSUMER_KEY')) $options['consumer_key'] = TWITTER_CONSUMER_KEY;
	if (defined('TWITTER_CONSUMER_SECRET')) $options['consumer_secret'] = TWITTER_CONSUMER_SECRET;
	return $options;
}
